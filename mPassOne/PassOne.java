...
public class PassOne {
	...
	public static void main(String[] args) throws IOException{
		BufferedReader br=new BufferedReader(new FileReader("mPassOne/macro_input.asm"));
		
		FileWriter mnt=new FileWriter("mPassOne/mnt.txt");
		FileWriter mdt=new FileWriter("mPassOne/mdt.txt");
		FileWriter kpdt=new FileWriter("mPassOne/kpdt.txt");
		FileWriter pnt=new FileWriter("mPassOne/pntab.txt");
		FileWriter ir=new FileWriter("mPassOne/intermediate.txt");
