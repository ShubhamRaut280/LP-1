...
public class PassTwo {
	...
	public static void main(String[] args) {
		...
		try {
			pass2.generateCode("PassTwo/IC.txt");
		} catch (Exception e) {
	...
	public void readtables()
	{
		...
		try
		{
			br=new BufferedReader(new FileReader("PassTwo/SYMTAB.txt"));
			...
			br.close();
			br=new BufferedReader(new FileReader("PassTwo/LITTAB.txt"));
			while((line=br.readLine())!=null)
			{
				String parts[]=line.split("\\s+");
	...
	public void generateCode(String filename) throws Exception
	{
		...
		BufferedWriter bw=new BufferedWriter(new FileWriter("PassTwo/PASS2.txt"));
		String line,code;
		while((line=br.readLine())!=null)
		{
			String parts[]=line.split("\\s+");
